 ...
 */
var figletPromise = function (txt, options) {
    if (options === void 0) { options = {}; }
    return new Promise(function (resolve, reject) {
        return figlet_1.default.text(txt, options, function (error, result) {
            if (error) {
                return reject(error);
            }
            resolve(result);
 ...
 */
var titleScreen = function (title) {
    return new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, figletPromise(title, {
                            font: "slant"
                        })];
                case 1:
                    text = _a.sent();
                    clear_1.default();
                    console.log(boxen_1.default(chalk_1.default.blueBright(text), exports.defaultBoxenStyle));
                    resolve();
                    return [3 /*break*/, 3];
                case 2:
                    e_1 = _a.sent();
