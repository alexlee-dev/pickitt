...
import pickImgPath from './images/pick.svg'
import pickStyle from './styles'

# Pickitt

<img src={pickImgPath} style={pickStyle}/>
...
**Pickitt** is a simple utility function designed to help you pick an element from a collection.
...
const randomElement = pickitt(testArray) // <-- 'item2'
```
